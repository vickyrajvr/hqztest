...
public class TPGAudioPlayer: NSObject {
    ...
    public func playPauseMediaFile(audioUrl: NSURL, springboardInfo: Dictionary <String, AnyObject>, startTime: Double, completion: @escaping (_ isPlaying : Bool,_ previousItem: String?, _ stopTime: Double) -> ()) {
        ...
        if audioUrl.absoluteString == self.currentPlayingItem {
            ...
            completion(self.isPlaying,nil, stopTime)
        ...
        DispatchQueue.global(qos: DispatchQoS.QoSClass.default).async {
            ...
            DispatchQueue.main.async(execute: {
                ...
                self.prepareAndPlay(playerAsset: playerAsset, startTime: startTime, completion: { () -> Void in
                    ...
                    completion(self.isPlaying,previousPlayingItem, stopTime)
