//
//  ArGearNetworkManager.swift
//  DubiDabi
//
//  Created by Zubair Ahmed on 16/05/2023.
//
...
// ARGEAER DUBI DABI APP CREDENTIALS   com.dubidabi.app

let API_HOST = "https://apis.argear.io/api/v3/"
let API_KEY1 = "API_KEY1"
let API_SECRET_KEY = "API_SECRET_KEY"
let API_AUTH_KEY = "API_AUTH_KEY"
...
class ArGearNetworkManager {

    static let shared = ArGearNetworkManager()
    ...
    func connectAPI(completion: @escaping (Result<[String: Any], APIError>) -> Void) {
        ...
        let urlString = API_HOST + API_KEY1
