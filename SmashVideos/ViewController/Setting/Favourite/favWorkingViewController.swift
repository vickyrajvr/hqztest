...
class favWorkingViewController: UIViewController,IndicatorInfoProvider {
    ...
    func getVideosAPI(){
        ...
        ApiHandler.sharedInstance.showFavouriteVideos(user_id: UserDefaultsManager.shared.user_id) { (isSuccess, response) in
            if isSuccess{
...
//    MARK:- sounds API
    ...
    func getHashtagsAPI(){
        ...
        ApiHandler.sharedInstance.showFavouriteHashtags(user_id: UserDefaultsManager.shared.user_id) { (isSuccess, response) in
...
extension favWorkingViewController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        vidCell.likeCountLbl.text = likeCount
...
extension favWorkingViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView == hashTagTV
        {
            ...
            hashCell.countLbl.text = hashObj.videos_count
           
            print("hashObj",hashObj.favourite)
...
//
            ...
            hashCell.btnFav.tag = indexPath.row
...
//        }
        ...
        //soundCell.favBtn.tag = indexPath.row
