...
//        navigationController?.popViewController(animated: true)
    ...
    func getSounds(){
        ...
        self.loader.isHidden = false
        ApiHandler.sharedInstance.showSoundsAgainstSection(user_id: UserDefaultsManager.shared.user_id, starting_point: "\(self.startingPoint)", sectionID: self.sectionID) { (isSuccess, response) in
            if isSuccess{
