...
class MainBottomFunctionView: UIView {
    ...
    let kMainBottomFunctionContentButtonName = "icContent"//"White_en" icContentWhite_en
...
//        self.contentButton.setImage(UIImage(named: contentButtonImageName), for: .normal)
    ...
    @IBAction func handleTapFrom(_ tap: UITapGestureRecognizer) {
        if tap.state == .ended {
            ...
            NotificationCenter.default.post(name: Notification.Name("closeBottomView"), object: nil)
        }
    }
    ...
    @IBAction func bottomButtonAction(_ sender: UIButton) {
        ...
        case .Beauty:
            ...
            NotificationCenter.default.post(name: Notification.Name("openBottomView"), object: nil)
        case .Filter:
